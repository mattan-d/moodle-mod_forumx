...
/**
 * The mod_forumx subscription deleted event.
 *
 * @package   mod_forumx
...
/**
 * The mod_forumx subscription deleted event class.
 *
...
class subscription_deleted extends \core\event\base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'forumx_subscriptions';
    }
    ...
    public static function get_name() {
        return get_string('eventsubscriptiondeleted', 'mod_forumx');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'forumx', 'unsubscribe', 'view.php?f=' . $this->other['forumid'],
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'forumx_subscriptions', 'restore' => 'forumx_subscription');
    }
