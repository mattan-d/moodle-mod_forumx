...
/**
 * The mod_forumx post created event.
 *
 * @package   mod_forumx
...
/**
 * The mod_forumx post created event class.
 *
...
class post_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostcreated', 'mod_forumx');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'forumx', 'add post', $logurl, $this->other['forumid'], $this->contextinstanceid);
    }
