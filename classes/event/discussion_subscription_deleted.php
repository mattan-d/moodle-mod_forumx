...
/**
 * The mod_forumx discussion_subscription deleted event.
 *
 * @package   mod_forumx
...
/**
 * The mod_forumx discussion_subscription deleted event class.
 *
...
class discussion_subscription_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventdiscussionsubscriptiondeleted', 'mod_forumx');
    }
