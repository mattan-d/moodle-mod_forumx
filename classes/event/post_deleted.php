...
/**
 * The mod_forumx post deleted event.
 *
 * @package   mod_forumx
...
/**
 * The mod_forumx post deleted event class.
 *
...
class post_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostdeleted', 'mod_forumx');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'forumx', 'delete post', $logurl, $this->objectid, $this->contextinstanceid);
    }
